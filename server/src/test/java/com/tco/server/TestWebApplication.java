...
public class TestWebApplication {
    ...
    //create test for serverPort = getServerPort(commandLineArguments)
    @Test
    @DisplayName("reecedw: getServerPort using command line argument")
    public void testGetServerPortUsingCommandLineArgument() {
        String[] commandLineArguments = {"31426"};
        assertEquals(31426, WebApplication.getServerPort(commandLineArguments));
    }
}
