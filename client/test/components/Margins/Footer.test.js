...
describe('Footer', () => {
    ...
    const setEnableDistances = jest.fn();
    const showMessage = jest.fn();
    const calculateDistances = jest.fn();
    ...
    beforeEach(() => {
        ...
        render(<Footer
            ...
            setEnableDistances={setEnableDistances}
    ...
    it('base: opens ServerSettings on link pressed and closes on cancel button', async () => {
    ...
    it('base: opens ServerSettings on link pressed and saves on close button', async () => {
        user.click(serverSettingsLink);
